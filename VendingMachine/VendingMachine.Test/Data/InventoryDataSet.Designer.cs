...
namespace VendingMachine.Test.Data {
    ...
    public partial class InventoryDataSet : global::System.Data.DataSet {
        ...
        public partial class InventoryDataTable : global::System.Data.TypedTableBase<InventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InventoryRow AddInventoryRow(string Name, int Quantity, decimal Price) {
...
namespace VendingMachine.Test.Data.InventoryDataSetTableAdapters {
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Inventory] WHERE (([Id] = @Original_Id) AND ([Name] = @Origina" +
                "l_Name) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Inventory] ([Name], [Quantity], [Price]) VALUES (@Name, @Quant" +
                "ity, @Price);\r\nSELECT Id, Name, Quantity, Price FROM Inventory WHERE (Id = SCOPE" +
                "_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Inventory] SET [Name] = @Name, [Quantity] = @Quantity, [Price] = @Price WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price));
SELECT Id, Name, Quantity, Price FROM Inventory WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::VendingMachine.Test.Properties.Settings.Default.InventoryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Quantity, Price FROM dbo.Inventory";
        ...
        public virtual int Insert(string Name, int Quantity, decimal Price) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, int Quantity, decimal Price, int Original_Id, string Original_Name, int Original_Quantity, decimal Original_Price, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
